...
export class BulkImageItemDto {
  @ApiProperty({
    description: 'GCS CDN URL of the generated image',
    example: 'https://storage.googleapis.com/bucket/generated-images/123/image.jpg',
  })
  imageUrl: string;

  @ApiProperty({
    description: 'Product Pose ID used for this image',
...
export class GenerateBulkImageResponseDto {
  ...
  @ApiProperty({
    description: 'Array of generated images with their details',
    type: [BulkImageItemDto],
  })
